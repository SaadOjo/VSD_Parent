...
MODULES                = rt_logging.c motorcycle_model.c motorcycle_model_capi.c motorcycle_model_data.c motorcycle_model_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = motorcycle_model.mk
MATLAB_ROOT            = D:\Program Files\MATLAB\R2018b
ALT_MATLAB_ROOT        = D:\Program Files\MATLAB\R2018b
MATLAB_BIN             = D:\Program Files\MATLAB\R2018b\bin
ALT_MATLAB_BIN         = D:\Program Files\MATLAB\R2018b\bin
MASTER_ANCHOR_DIR      = 
START_DIR              = C:\Users\MASTER~1\Desktop\VSD_PR~1\MOTORC~1
...
NCSTATES            = 52
MULTITASKING        = 0
PCMATLABROOT        = D:\\Program Files\\MATLAB\\R2018b
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = motorcycle_model_ref.rsp
MODELREF_INC_PATH         = 
COMPILER_COMMAND_FILE     = motorcycle_model_comp.rsp
...
BUILDINFO_INCLUDES = $(BUILDINFO_INCLUDES);$(START_DIR)\slprj\raccel\motorcycle_model
